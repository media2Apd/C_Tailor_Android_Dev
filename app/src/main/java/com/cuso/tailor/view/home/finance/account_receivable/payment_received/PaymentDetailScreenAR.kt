...
package com.cuso.tailor.view.home.finance.account_receivable.payment_received
...
import com.cuso.tailor.view.home.finance.account_payable.payment_mode.OrderLineItem
import com.cuso.tailor.view.home.finance.account_payable.payment_mode.PaymentHistoryEntry
...
private fun PaymentModeBadge(mode: String) {
    ...
    val (bg, text) = when (mode.uppercase()) {
        ...
        else -> grey_border to Color(0xFF6B7280)
    }
    Box(
        modifier = Modifier
